...
function integrateGitment(router) {
    ...
    function renderGitment(parentEl, path) {
        ...
        const gitment = new Gitment({
            ...
            id: path,
            owner: 'macheng2017', // 必须是你自己的github账号
            repo: 'article', // 上一个准备的github仓库
            link: location.origin + path,
            oauth: {
                client_id: '3e5aef756e79b00046f9', // 第一步注册 OAuth application 后获取到的 Client ID
                client_secret: 'b33786418f82045bdd4213db30483e79fede639a', // 第一步注册 OAuth application 后获取到的 Clien Secret
            },
        })
